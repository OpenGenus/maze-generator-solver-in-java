 ...
 */
 ...
 public class Maze extends JPanel implements Runnable {
    ...
    JFrame window = new JFrame("Maze Generater & Solver");
    // Set the content pane of the JFrame to a new instance of the Maze class
    ...
    int rows = 35; // number of rows of cells in maze, including a wall around edges
    int columns = 63; // number of columns of cells in maze, including a wall around edges
